...
# This script downloads Qwen Image models for ComfyUI.
#
# Usage:
...
define_downloads() {
    ...
    # Global array
    DOWNLOADS_DEF=(
        "https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/text_encoders/qwen_2.5_vl_7b_fp8_scaled.safetensors;$COMFYUI_PATH/models/text_encoders/qwen_2.5_vl_7b_fp8_scaled.safetensors"
        "https://huggingface.co/lightx2v/Qwen-Image-Lightning/resolve/main/Qwen-Image-Lightning-4steps-V1.0.safetensors;$COMFYUI_PATH/models/loras/Qwen-Image-Lightning-4steps-V1.0.safetensors"
        "https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_2512_bf16.safetensors;$COMFYUI_PATH/models/diffusion_models/qwen_image_2512_bf16.safetensors"
        "https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_2512_fp8_e4m3fn.safetensors;$COMFYUI_PATH/models/diffusion_models/qwen_image_2512_fp8_e4m3fn.safetensors"
